...
@Component({
  selector: 'app-cli-lista-pedidos',
  templateUrl: './cli-lista-pedidos.component.html',
  styleUrls: ['./cli-lista-pedidos.component.css']
})
export class CliListaPedidosComponent implements OnInit {
